...
class SVM(Solver):
    ...
    def fit(
        ...
        error_cache = self.kernel_func(x_train)[1] - y_train  # auxilary array for heuristics
        ...
        while iter_idx < self.max_iter:
            ...
            _, score_1 = self.kernel_func(x_1)
            _, score_2 = self.kernel_func(x_2)
            ...
            # Update error cache
            error_cache[i_1] = self.kernel_func(x_1)[1] - y_1
            error_cache[i_2] = self.kernel_func(x_2)[1] - y_2
    ...
    def check_kkt(
        ...
        _, score_idx = self.kernel_func(self.support_vectors[check_idx, :])
